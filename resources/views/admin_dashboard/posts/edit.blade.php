...
@section("style")
    ...
    <script src="https://cdn.tiny.cloud/1/e6f97qv36ryzniin0m58o7dhvtgc4g25n1zd228xb5fpqukw/tinymce/5/tinymce.min.js" referrerpolicy="origin"></script>
@endsection
@section("wrapper")
    <!--start page wrapper -->
        ...
        <div class="page-content">
            ...
            <div class="card">
                <div class="card-body p-4">
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="border border-3 p-4 rounded">
                                        ...
                                        <div class="mb-3">
                                            <label for="inputProductTitle" class="form-label">Post Destination</label>
                                            <div class="card">
                                                <div class="card-body">
                                                    <div class="rounded">
                                                        <div class="mb-3">
                                                            <select required name='category_id' class="single-select form-control ">
                                        ...
                                        <div class="mb-3">
                                            <div class="row">
                                                ...
                                                <div class="col-md-4 text-center">
                                                    <img  width="100%" src="/storage/{{$post->image? $post->image->path : 'placeholders/thumbnail_placeholder.svg'}}"  class="img-fluid" alt="Post Thumbnail">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <a class="btn btn-danger" type="submit" onclick="event.preventDefault();document.getElementById('delete_category_{{$post->id}}').submit();" href="#">
                                            Delete Post
                                        </a>
                    ...
                    <form method="POST" id="delete_category_{{$post->id}}" action="{{route('admin.posts.destroy', $post)}}">
                        @csrf
                        @method('DELETE')
                    </form>
                </div>
